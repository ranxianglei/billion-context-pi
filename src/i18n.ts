...
"settings.saveFailed": "保存失败: {error}",
  ...
  "settings.usageTriggerPercent": "触发压缩水位 (%)",
  "settings.usageTriggerPercent.desc": "上下文使用率到达该百分比时注入压缩提示。0=禁用，默认 25。",
  "settings.toolOutputClean": "工具输出清洗",
  "settings.toolOutputClean.desc": "折叠 bash 输出重复行与连续空行。默认开。",
...
"settings.hint": "enter/space change • type to search • esc close",
  ...
  "settings.usageTriggerPercent": "Trigger compression level (%)",
  "settings.usageTriggerPercent.desc": "Inject compression nudge when context usage reaches this percent. 0=disabled, default 25.",
  "settings.toolOutputClean": "Tool output cleaning",
  "settings.toolOutputClean.desc": "Fold repeated lines and blank runs in bash output. Default on.",
