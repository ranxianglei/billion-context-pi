...
export type AcpToolName = "compress" | "decompress" | "search_context" | "acp_status" | "acp_cache" | "absorb";
...
const TOOL_NAMES: ReadonlySet<string> = new Set(["compress", "decompress", "search_context", "acp_status", "acp_cache", "absorb"]);
